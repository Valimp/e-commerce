  ...
  return (
    <div className='h-auto bg-deep-green flex items-start px-10 py-6 gap-24'>
        <nav className='flex flex-col'>
            <h3 className='text-sun-orange text-lg'>Navigation</h3>
        ...
        <div className='flex flex-col'>
            <h3 className='text-sun-orange text-lg'>Nous contacter</h3>
            <Separator horizontal="15px" />
        ...
        <div>
            <h3 className='text-sun-orange text-lg'>Suivez-nous</h3>
            <Separator horizontal="15px" />
            <BadgeLink />
